...
# 득점은 결과를 아는 경기만(None 이면 미입력).
MATCHES = [
    ("2026-06-28 13:40", "스카이", "HUMBLE", "인재개발원", 1, 1),
    ("2026-07-12 11:30", "스카이", "시누쓰", "인재개발원", 2, 0),
...
class Command(BaseCommand):
    ...
    def handle(self, *args, **opts):
        ...
        self.stdout.write(
            "※ 스코어 미확보 지난 경기(7/12 HUMBLE-ACI)는 종료 상태에 스코어 비움 — "
            "대회 상세의 '편집'에서 결과를 입력하세요.")
